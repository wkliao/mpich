...
{
    int i, proc, *aggr_ranks, stripe_size;
    MPI_Count l, *count_my_req_per_proc, count_my_req_procs;
    size_t nelems;
                                   ...
                                   ADIO_Status *status, int *error_code)
{
    ...
    int striping_info[3], do_collect = 0;
    ...
    if ((fd->romio_write_aggmethod == 1) || (fd->romio_write_aggmethod == 2)) {
        ...
        ADIOI_Access *my_req;
        MPI_Count count_my_req_procs, *count_my_req_per_proc;
        ...
        ADIOI_Access *others_req;
        MPI_Count count_others_req_procs, *count_others_req_per_proc;
                                        ...
                                        int *striping_info, ADIO_Offset **buf_idx, int *error_code)
{
    ...
    *error_code = MPI_SUCCESS;
    ...
    for (m = 0; m < ntimes; m++) {
        ...
        ADIOI_LUSTRE_WR_LOCK_AHEAD(fd, striping_info[2], range_off, error_code);
        if (*error_code != MPI_SUCCESS)
            goto over;
