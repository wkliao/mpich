...
#ifdef WKL_DEBUG
if (num_memcpy> 0) printf("---- contig_access_count=%d i=%d n_buftypes=%d fileview_indx=%d flat_buf->count=%lld num_memcpy=%d\n",contig_access_count,i,*n_buftypes,*fileview_indx,flat_buf->count,num_memcpy);
#endif
}
