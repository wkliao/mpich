    ...
    for (roundIter = 0; roundIter < numberOfRounds; roundIter++) {
        ...
        for (i = 0; i < numTargetAggsThisRound; i++) {
            ...
            if (roundIter > 0) {
                ...
                MPI_Isend
#endif
                           (&((char *) buf)[sendBufferOffsetsThisRound[irecv]],
                ...
                MPI_Isend
#endif
                           (&((char *) buf)[sendBufferOffsetsThisRound[i]],
        ...
        for (i = 0; i < numSourceProcs; i++) {
            ...
            if (dataSizeGottenThisRoundPerProc[i] > 0) {
                ...
                MPI_Irecv
#endif
                           (&((char *) write_buf)[currentWBOffset],
    ...
    *error_code = MPI_SUCCESS;
    ...
    for (roundIter = 0; roundIter < numberOfRounds; roundIter++) {
        ...
        for (i = 0; i < numSourceAggsThisRound; i++) {
            ...
            MPI_Irecv
#endif
                       (&((char *) buf)[recvBufferOffsetsThisRound[i]],
